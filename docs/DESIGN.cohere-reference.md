# Riferimento d'ispirazione — sistema visivo di Cohere

> **Questo documento NON descrive SNM.Intelligence.** È la documentazione del sistema visivo del
> sito di Cohere, estratta come riferimento d'ispirazione all'inizio del progetto: da qui vengono
> il nero di marchio, il verde profondo, il coral, i CTA a pastiglia e la banda scura a piena
> larghezza che il progetto ha effettivamente adottato.
>
> Il sistema **reale** del progetto — con le tinte semantiche dei rilevatori, le quattro superfici
> scure e i componenti narrativi (`BandaScura`, `EtichettaMono`, `SchedaCifra`, `Blocco`,
> `IndiceAtti`) — è documentato in [`DESIGN.md`](../DESIGN.md) alla radice del repository.
>
> Buona parte di ciò che segue qui non esiste in questo progetto: announcement bar, trust-logo
> strip, footer newsletter, hero-photo-card, research-table. Va letto come fonte, non come specifica.
